...
class LabelTest(unittest.TestCase):
    ...
    def test_split_contain_perpen(self):
        ...
        self.assertEqual(copmanager.splitContainPerp(Ib+I_perpen, labels), (I_perpen, Ib))
    ...
    def test_get_leading(self):
        ...
        self.assertEquals(X, Label.make(8,constant.PERPEN_SYM, 0, 0, 0, 0))
...
class RepeatedKey(unittest.TestCase):
    def setUp(self):
        self.label = [SV(1,0), SV(2,0),  SV(5,0), SV(5,constant.PERPEN_SYM)]
...
class RootedTreeManipulationTest(unittest.TestCase):
    ...
    def test_descendent_check(self):
        ...
        self.assertEqual(sorted(copmanager.descendant(self.rt, 0, 2)), [1,2, 3])
    ...
    def test_subForest(self):
        ...
        rt2.tree.add_node(2)
        self.assertEqual(str(copmanager.subForest(self.rt,0)), str([rt1, rt2]))
